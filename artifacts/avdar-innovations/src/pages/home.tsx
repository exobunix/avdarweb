...
import { 
  ...
  Zap, Shield, Clock, Users, Search, MessageSquare, Star, 
  Building2, Factory, Landmark, ShoppingBag, HeartPulse, GraduationCap
} from "lucide-react";
import heroVideo from "@/assets/avdar-video-1.mp4";
import storyVideo from "@/assets/avdar-video-2.mp4";
    ...
    <PageLayout>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-30 text-center flex flex-col items-center">
          ...
          <AnimatedText 
            text="Building the Future of Business Software"
            className="text-5xl md:text-7xl lg:text-8xl font-display font-bold leading-tight mb-6 max-w-5xl"
          />
          
          <FadeIn delay={0.4}>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 leading-relaxed">
              We engineer enterprise AI solutions, SaaS platforms, and intelligent digital ecosystems that transform how visionaries operate.
            </p>
          </FadeIn>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="glass-panel p-6 text-center rounded-2xl hover:border-white/20 hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="py-24 relative overflow-hidden bg-white/[0.02]">
        <div className="container mx-auto px-6">
          <FadeIn className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-6">Why Avdar Innovations?</h2>
            <p className="text-muted-foreground text-lg">We don't just write code; we solve business problems. Our engineering philosophy is built on speed, intelligence, and uncompromising reliability.</p>
          </FadeIn>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <GlassCard className="flex flex-col relative overflow-hidden group h-full">
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-6">
          <FadeIn className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Ecosystem of Innovation</h2>
            ...
            <Link href="/services" className="flex items-center gap-2 text-primary hover:text-white transition-colors group">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <FadeIn key={i} delay={i * 0.15}>
                <GlassCard className="flex flex-col items-start h-full">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Our Technology Ecosystem</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
            {technologies.map((tech, i) => (
              <motion.div
                ...
                className="px-6 py-3 rounded-full bg-white/5 border border-white/10 text-white/90 font-mono text-sm hover:bg-white/10 hover:border-primary/50 transition-all cursor-default shadow-lg"
              >
                {tech}
              </motion.div>
            ))}
      ...
      <section className="py-24 bg-black/40 border-y border-white/5">
        <div className="container mx-auto px-6">
          <FadeIn className="mb-16 text-center">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">How We Build</h2>
                ...
                >
                  <div className={`flex flex-col md:flex-row items-center gap-8 group ${i % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                    <div className={`w-full md:w-1/2 ${i % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                      <h3 className="text-2xl font-display font-bold text-white mb-2 group-hover:text-primary transition-colors">{proc.title}</h3>
                      <p className="text-muted-foreground">{proc.desc}</p>
                    </div>
                    <div className="relative shrink-0 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-background border-4 border-white/10 text-primary font-mono font-bold text-sm group-hover:border-primary/50 group-hover:scale-110 transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.5)]">
                      {proc.num}
                    </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="glass-panel p-2 rounded-3xl overflow-hidden shadow-[0_0_50px_-12px_rgba(2,132,199,0.3)]">
            <div className="relative aspect-video rounded-2xl overflow-hidden bg-muted">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-transparent to-transparent flex items-end p-8 md:p-12">
                <div className="max-w-2xl">
                  <h3 className="text-3xl md:text-4xl font-display font-bold mb-4">Intelligent by Design</h3>
                  <p className="text-white/80 text-lg">Watch how Avdar Innovations integrates generative AI directly into enterprise workflows, making your data work for you.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 border-y border-white/5 overflow-hidden flex flex-col items-center">
        <div className="container mx-auto px-6 mb-10 text-center flex flex-col md:flex-row items-center justify-between gap-4">
          <h2 className="text-2xl font-display font-bold">Industries We Transform</h2>
          <Link href="/industries" className="text-primary text-sm font-semibold hover:text-white transition-colors flex items-center gap-1">
        ...
        <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
          <ul className="flex items-center justify-center md:justify-start [&_li]:mx-4 [&_img]:max-w-none animate-[infinite-scroll_30s_linear_infinite]">
            {industries.concat(industries).map((ind, i) => (
              <li key={i} className="flex flex-col items-center gap-3 glass-panel px-8 py-6 rounded-2xl min-w-[200px]">
      ...
      <section className="py-24 bg-gradient-to-b from-transparent to-primary/5">
        <div className="container mx-auto px-6 text-center">
          <FadeIn>
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-6">Proprietary AI SaaS</h2>
            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.15}>
                <GlassCard className="relative overflow-hidden group h-full">
                  ...
                  <h3 className="text-2xl font-display font-bold mb-3">{prod.name}</h3>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">Client Impact</h2>
            ...
            {testimonials.map((test, i) => (
              <div key={i} className="min-w-[320px] md:min-w-[400px] flex-shrink-0 snap-center">
                <GlassCard className="h-full flex flex-col">
                  ...
                  <p className="text-white/90 text-lg leading-relaxed mb-8 flex-grow">"{test.quote}"</p>
                  <div>
      ...
      <section className="py-32 relative">
        <div className="container mx-auto px-6">
          <div className="glass-panel p-12 md:p-24 rounded-3xl text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground mb-10">Partner with Avdar Innovations to engineer your next big leap.</p>
              <Link href="/contact">
